...
class BlogController extends BackendController
{
    ...
    public function store(PostRequest $request)
    {
        ...
        return redirect(route('backend.blog.index'))->with('message', 'Your post created successfully! ');
    }
    ...
    public function update(PostRequest $request, $id)
    {
        ...
        return redirect(route('backend.blog.index'))->with('message', 'Your post update successfully! ');
    }
